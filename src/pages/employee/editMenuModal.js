...
import {
    ...
    HStack, VStack, Flex, Select, CheckboxGroup, Checkbox, Textarea
...
const EditMenuModal = (props) => (
    <Modal isOpen={props.isOpen} onClose={props.onClose}>
        ...
        <ModalContent color="#372F2F" backgroundColor="#BCC8C3" maxWidth="550px">
            <ModalHeader>
                <VStack>
                    <Image src={props.drink.imagePath} w={300} ratio={1} mt="50px" />
                    <Input
                        width="300px"
                        type="file"
                        accept="image/*"
                        ...
                        onChange={(e) => {
                            ...
                            if (file) {
                                ...
                                reader.onloadend = () => {
                                    props.setDrinkImage(reader.result);
                                };
            ...
            <ModalBody>
                <FormControl>
                    <Flex align="center">
                        ...
                        <Spacer />
                        <Input
                            defaultValue={props.drink.drinkName}
                ...
                <FormControl mt={4}>
                    <Flex align="center">
                        ...
                        <Spacer />
                        <Select
                            defaultValue={props.drink.category}
                            backgroundColor="#F3F1E8"
                            borderColor="#7B7875"
                            width="320px"
                            _hover={{ borderColor: "#A0B2AB" }}
                ...
                <FormControl mt={4}>
                    <Flex align="center">
                        ...
                        <Spacer />
                        <CheckboxGroup defaultValue={props.drink.sizeOptions} width="320px">
                            <HStack spacing={4}>
                ...
                <FormControl mt={4}>
                    <Flex align="center">
                        ...
                        <Spacer />
                        <CheckboxGroup defaultValue={props.drink.iceLevelOptions}>
                ...
                <FormControl mt={4}>
                    <Flex align="center">
                        ...
                        <Spacer />
                        <CheckboxGroup defaultValue={props.drink.sugarLevelOptions}>
                            <Flex width="320px" justifyContent="flex-end">
                                <VStack align="flex-end" spacing={4}>
                                    <Flex justifyContent="flex-end" width="100%">
                                        <Checkbox value="0%" colorScheme="teal">0%</Checkbox>
                ...
                <FormControl mt={4}>
                    <Flex align="center">
                        ...
                        <Spacer />
                        <Textarea
                            defaultValue={props.drink.ingredients.map(ingredient => ingredient.ingredientName).join('\n')}
                            backgroundColor="#F3F1E8"
                            borderColor="#7B7875"
                            width="320px"
                            _hover={{ borderColor: "#A0B2AB" }}
                ...
                <FormControl mt={4}>
                    <Flex align="center">
                        ...
                        <Box pr="5px">$</Box>
                        <Input
                            defaultValue={props.drink.basePrice}
                            backgroundColor="#F3F1E8"
                            borderColor="#7B7875"
                            width="80px"
                            _hover={{ borderColor: "#A0B2AB" }}
